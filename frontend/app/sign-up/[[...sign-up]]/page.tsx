    ...
    >
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm font-body" style={{ color: "#888" }}>Create your account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="rounded-2xl p-6 flex flex-col gap-4" style={{ background: "#141414", border: "1px solid #252525" }}>
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-body uppercase tracking-widest" style={{ color: "#888" }}>Name</label>
            <input
              type="text"
              value={name}
        ...
        <p className="text-center text-sm font-body mt-5" style={{ color: "#888" }}>
          ...
          <Link href="/sign-in" style={{ color: "#C8FF00" }}>Sign in</Link>
        </p>
      </div>
    </main>
  );
